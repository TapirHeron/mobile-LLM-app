<p align="center">
  <img src="docs/images/logo.png" alt="智随心动 MindFlow - AI Android Automation" width="120" height="120">
</p>

<h1 align="center">智随心动 MindFlow</h1>

<p align="center">
  <strong>无需电脑的开源 AI 手机自动化助手 | AI Phone Automation Assistant</strong>
</p>
...
> 正在开发的重大更新，目前在 `MindFlow2.0+AccessibilityService` 分支
...
请在 [GitHub Issues](https://github.com/TapirHeron/mobile-LLM-app/issues) 提交问题，附上：
- 问题描述
- 复现步骤
- 导出的日志文件
